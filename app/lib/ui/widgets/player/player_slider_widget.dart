...
class ActiveSlider extends StatelessWidget {
  final double height;
  ...
  Widget build(BuildContext context) {
    return GetX<PlayerSliderController>(
      builder: (controller) {
        double sectionWidth =
            (controller.endPosition - controller.startPosition) * totalWidth;
        return Stack(
          children: [
            Positioned(
              top: 0,
              left: controller.startPosition * totalWidth,
              width: sectionWidth,
              height: height,
              child: Container(
                color: Colors.blue,
                // height: height,
                // width: sectionWidth * controller.sliderFraction,
              ),
            ),
            Positioned(
              top: 0,
            ...
            Positioned(
              top: 0,
              left: controller.endPosition * totalWidth,
              width: 10,
              height: height,
              child: Container(
                color: Colors.green,
